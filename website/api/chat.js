// Vercel fallback: if the Vercel project root is set to `website/`,
// this function still exists at `/api/chat`.
//
// Keep this file dependency-free: no imports from repo root.
